...
const InfoTab = ({ gameComponents, activeGame, setActiveGame, setActiveTab }) => {
    const learningObjectives = [
        {
            icon: "🧠",
            title: "Pemahaman konsep penjumlahan dan pengurangan",
            description: "Siswa mampu menjelaskan makna menambah dan mengurangi sebagai bagian dari operasi hitung dasar."
        },
        {
            icon: "➕ ➖",
            title: "Kemampuan Operasional berhitung",
            description: "Siswa dapat menyelesaikan soal penjumlahan dan pengurangan 11–20 secara mandiri melalui latihan bertahap."
        },
        {
            icon: "🎨",
            title: "Penggunaan Strategi Visual",
            description: "Menyelesaikan soal memakai bantuan gambar, atau ilustrasi, sesuai dengan pendekatan konkret–semi konkret yang diterapkan pada pembelajaran kelas awal"
        },
        {
            icon: "⚖️",
            title: "Membandingkan jumlah",
            description: "Siswa dapat membandingkan jumlah benda dan menentukan apakah jumlahnya lebih banyak, lebih sedikit, atau sama dengan jumlah lainnya."
        }
    ];
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        {game.id === 2 && (
                                            <>
                                                ...
                                                <span className="text-xs px-2 py-1 bg-[#f0f7ff] text-[#355485] rounded-full">Skor</span>
                                            </>
                                        )}
                                        {game.id === 3 && (
                                            <>
                                                <span className="text-xs px-2 py-1 bg-purple-50 text-purple-600 rounded-full">10 Soal</span>
                                                <span className="text-xs px-2 py-1 bg-purple-50 text-purple-600 rounded-full">Hint</span>
