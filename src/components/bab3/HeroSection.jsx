                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                      ...
                      <div className="lg:w-2/3">
                          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
                              <span className="text-sm font-medium">Bab 3 • Kelas 1 Semester 1</span>
                          </div>

                          <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
                              Mengenal <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#90b6d5] to-[#4f90c6]">Pengurangan</span>
                          </h1>

                          <p className="text-xl opacity-90 mb-6 max-w-2xl">
                              Pelajari konsep pengurangan melalui permainan sederhana yang membantu memahami proses mengurangi jumlah dalam kehidupan sehari-hari.
                          </p>
                          ...
                          <div className="relative">
                              <div className="w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-[#4f90c6]/20 to-[#90b6d5]/20 rounded-3xl flex items-center justify-center backdrop-blur-sm border border-white/10">
                                  <div className="text-center">
                                      <div className="text-6xl md:text-8xl mb-4">➖1️⃣0️⃣</div>
                                      <div className="text-white/80 text-sm">Pengurangan</div>
                                  </div>
                              </div>
                          </div>
                      </div>
